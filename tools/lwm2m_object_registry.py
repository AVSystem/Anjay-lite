...
def _print_object_definition(urn_or_oid, version, output_file):
    xml_file = get_object_definition(urn_or_oid, version)
...
if __name__ == '__main__':
    ...
    if args.list:
        ...
        _print_object_definition(args.get_xml, args.object_version, args.output)
    else:
        parser.print_usage()
        sys.exit(1)
