...
ANJ_UNIT_TEST(dm, add_remove_object) {
    ...
    ANJ_UNIT_ASSERT_SUCCESS(anj_dm_add_obj(&anj, &obj_81));
    anj_dm_obj_t obj_82 = {
        .oid = 82
    };
    ANJ_UNIT_ASSERT_SUCCESS(anj_dm_add_obj(&anj, &obj_82));
    anj_dm_obj_t obj_83 = {
        .oid = 83
    };
    ANJ_UNIT_ASSERT_SUCCESS(anj_dm_add_obj(&anj, &obj_83));
    anj_dm_obj_t obj_84 = {
        .oid = 84
    };
    ANJ_UNIT_ASSERT_SUCCESS(anj_dm_add_obj(&anj, &obj_84));
    anj_dm_obj_t obj_85 = {
        .oid = 85
    };
    ...
    ANJ_UNIT_ASSERT_EQUAL(anj.dm.objs_count, 13);
    ANJ_UNIT_ASSERT_SUCCESS(anj_dm_remove_obj(&anj, 2));
    ANJ_UNIT_ASSERT_EQUAL(anj.dm.objs_count, 12);
    ANJ_UNIT_ASSERT_SUCCESS(anj_dm_remove_obj(&anj, 3));
    ANJ_UNIT_ASSERT_EQUAL(anj.dm.objs_count, 11);
    ANJ_UNIT_ASSERT_SUCCESS(anj_dm_add_obj(&anj, &obj_3));
    ANJ_UNIT_ASSERT_EQUAL(anj.dm.objs_count, 12);
    ANJ_UNIT_ASSERT_SUCCESS(anj_dm_remove_obj(&anj, 2));
    ANJ_UNIT_ASSERT_EQUAL(anj.dm.objs_count, 11);
