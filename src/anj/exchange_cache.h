 ...
 * @param exchange_lifetime EXCHANGE_LIFETIME used to calculate expiration
 *                          time.
...
/**
 * Checks if a message with the same message ID has already been seen during the
 * current EXCHANGE_LIFETIME.
 *
 ...
 *
 * @param ctx        Exchange cache context.
 * @param msg        Message whose message ID will be checked.
 *
 * @returns One of:
